/* Template: Corso & Mikesuwan
   Author: Inovatik & Mikesuwan
   Created: 2023
...
//	 $('#clock').countdown('2022/04/28 08:50:56') /* change here your "countdown to" date */
...
//    });
    ...
    const datecrate  = '2022';
    document.getElementById("yearstart").innerHTML = datecrate;
    const datecheck  = datefooter.getFullYear();
    if(datecrate == datecheck){
        document.getElementById("show_year").innerHTML = 'Present';
    } else {
        document.getElementById("show_year").innerHTML = datecheck;
    }
